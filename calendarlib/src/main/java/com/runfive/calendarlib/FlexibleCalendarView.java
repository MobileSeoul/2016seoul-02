package com.runfive.calendarlib;
...
import com.runfive.calendarlib.entity.SelectedDateItem;
import com.runfive.calendarlib.exception.HighValueException;
import com.runfive.calendarlib.view.BaseCellView;
import com.runfive.calendarlib.view.impl.DateCellViewImpl;
import com.runfive.calendarlib.view.impl.WeekdayCellViewImpl;
...
public class FlexibleCalendarView extends LinearLayout implements
    ...
    private class DefaultCalendarView implements CalendarView {
        ...
        public BaseCellView getCellView(int position, View convertView, ViewGroup parent,
            ...
            if(cellView == null){
                ...
                cellView = (BaseCellView)inflater.inflate(com.runfive.calendarlib.R.layout.square_cell_layout,null);
            }
            return cellView;
        }
    ...
    private void setAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, com.runfive.calendarlib.R.styleable.FlexibleCalendarView);
        try {
            Calendar cal = Calendar.getInstance(FlexibleCalendarHelper.getLocale(context));
            displayMonth = a.getInteger(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_startDisplayMonth,cal.get(Calendar.MONTH));
            displayYear = a.getInteger(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_startDisplayYear, cal.get(Calendar.YEAR));
            startDisplayDay = cal.get(Calendar.DAY_OF_MONTH);

            weekdayHorizontalSpacing = (int)a.getDimension(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_weekDayHorizontalSpacing, 0);
            weekdayVerticalSpacing = (int)a.getDimension(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_weekDayVerticalSpacing, 0);
            monthDayHorizontalSpacing = (int)a.getDimension(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_monthDayHorizontalSpacing, 0);
            monthDayVerticalSpacing = (int)a.getDimension(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_monthDayVerticalSpacing,0);

            monthViewBackground = a.getResourceId(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_monthViewBackground,android.R.color.transparent);
            weekViewBackground = a.getResourceId(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_weekViewBackground, android.R.color.transparent);

            showDatesOutsideMonth = a.getBoolean(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_showDatesOutsideMonth, false);
			decorateDatesOutsideMonth = a.getBoolean(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_decorateDatesOutsideMonth, false);
            disableAutoDateSelection = a.getBoolean(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_disableAutoDateSelection, false);

            startDayOfTheWeek = a.getInt(com.runfive.calendarlib.R.styleable.FlexibleCalendarView_startDayOfTheWeek, Calendar.SUNDAY);
