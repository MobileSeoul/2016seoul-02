 ...
 */
public class HanGangTennisInfoObject {
    private String gigu;    // 한강 지구번호
    private double latitude;   // 위도
    private double longitude;   // 경도
    private String name; // 테니스장 명
    private String tel; // 전화번호
    private String fee; // 요금

    public HanGangTennisInfoObject(String gigu, double lng, double lat, String name, String tel, String fee) {
        this.gigu = gigu;
        this.longitude = lng;
        this.latitude = lat;
        this.name = name;
