...
public class RecordDistance extends Fragment {
    private String user_id;
    private ChartView chartview;
    private Calendar cal;
    private int dayNum; // 이번달 날짜
    private int today; // 오늘 날짜
    private Hashtable distanceTable;
...
//        이번달의 마지막 날짜
        ...
        View rootView = inflater.inflate(R.layout.record_distance_fragment, container, false);
        chartview = (ChartView) rootView.findViewById(R.id.distance_chartview);
    ...
    private List<PointValue> getPoint() {
        ...
        for (int i = 1; i <= dayNum; i++) {
            ...
            if (distanceTable != null && distanceTable.get(i) != null) {
                pointValue.verical_value = "" + distanceTable.get(i);
            } else {
    ...
    private void config(int mScreenWidth, List<KeduValue> listHorizontal, List<PointValue> listPoint, List<PointValue> listPointRegion) {
        ...
        config
                ...
                // Y축 Text
                .setVerical_unit_text("km")
                // Y축 시작 기준
                .setVerical_unit_start(0)
                // Y 축 끝
                .setVerical_unit_end(40)
                // 몇씩 증가
                ...
                // 풍선 메인 타이틀
                //.setIndicator_title_unit("km")
                // 풍선 색
                .setIndicator_Linecolor(R.color.colorPrimary)
                // 풍선 옮길때 겉 색
                //.setIndicator_outside_circle_color(R.color.transparent)
                // 풍선 타이틀 글자 색
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                  ...
                  /*  username = new String[results.length()];
                    totalDistance = new String[results.length()];
                    ...
                    for (int i = 0; i < results.length(); ++i) {
                        ...
                        distanceTable.put(dayInteger, temp.getString("distance"));
                    }
