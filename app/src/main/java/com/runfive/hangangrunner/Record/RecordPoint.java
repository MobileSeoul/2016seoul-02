...
public class RecordPoint extends Fragment {
    private String user_id;
    private ChartView chartview;
    private Calendar cal;
    private int dayNum; // 이번달 날짜
    private int today; // 오늘 날짜
    private Hashtable pointTable;
...
//        이번달의 마지막 날짜
        ...
        View rootView = inflater.inflate(R.layout.record_point_fragment, container, false);
        chartview = (ChartView) rootView.findViewById(R.id.point_chartview);
    ...
    private List<PointValue> getPoint() {
        ...
        for (int i = 1; i <= dayNum; i++) {
            ...
            if (pointTable != null && pointTable.get(i) != null) {
                pointValue.verical_value = "" + pointTable.get(i);
            } else {
                pointValue.verical_value = "" + 0;
            }
            pointValue.title = pointValue.verical_value + "";
            pointValue.title_sub = "Point";
            list.add(pointValue);
        }
        return list;
    }
    ...
    private void config(int mScreenWidth, List<KeduValue> listHorizontal, List<PointValue> listPoint, List<PointValue> listPointRegion) {
        ...
        config
                ...
                // Y축 Text
                .setVerical_unit_text("Point")
                // Y축 시작 기준
                .setVerical_unit_start(0)
                // Y 축 끝
                .setVerical_unit_end(400*6)
                // 몇씩 증가
                .setVerical_unit_incremetal(200)
                //
                ...
                .setRegion_color(R.color.LightGray)
                ...
                .setRegion_connect_color(R.color.LightGray)

                // 연결선 색
                .setPath_line_color(R.color.content_text)
                // 포인트 원 안에 색
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    for (int i = 0; i < results.length(); ++i) {
                        ...
                        pointTable.put(dayInteger, temp.getString("user_point"));
                    }
